...
valid_loader = torch.utils.data.DataLoader(data_valid, batch_size=batch_size, shuffle=True, num_workers=0)
test_loader  = torch.utils.data.DataLoader(data_test,  batch_size=batch_size, shuffle=True, num_workers=0)
...
savepath_ES   = "./model/model_0.50.50.5.pth.tar"
savepath_last = "./model/model_0.50.50.5_last.pth.tar"
...
model = ResNet_modify(0.5,0.5,0.5)
print(model)
...
plt.savefig("./lab3-2_0.50.50.5_loss.png")
plt.close()
...
plt.ylabel('Accuracy(%)')
plt.legend(loc='upper right')
plt.savefig("./lab3-2_0.50.50.5_acc.png")
plt.close()
